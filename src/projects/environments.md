...
Using [Amazon Linux 2](https://aws.amazon.com/amazon-linux-2/) (`php-8.0:al2`, `php-8.1:al2`, `php-8.2:al2`, `php-8.2:al2-arm`) is **highly recommended**, as Amazon Linux 1 is no longer maintained as of December 31, 2020.
:::
